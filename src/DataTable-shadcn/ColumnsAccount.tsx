...
export const columnsAccount: ColumnDef<AccountInterface>[] = [
  {
    accessorKey: "id",
    header: "ID",
  },
      ...
      return (
        <div className="flex justify-center gap-1 items-center">
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
              <CardCreateAccount account={accounts} isUpdate={true} 
                onSuccess={() => setIsDialogOpen(false)} />
            </DialogContent>
          </Dialog>
          {/* DELETAR*/}
          <DeleteAccount id={accounts.id} />
        </div>
      );
    },
  },
